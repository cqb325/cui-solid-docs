...
export class SymbolTree {
     ...
     * @return {Object}
     */
    lastInclusiveDescendant (object: any) {
        let lastChild;
        let current = object;
     ...
     * @return {?Object}
     */
    preceding (object: any, options?: OperationOptions) {
     ...
     * @return {?Object}
     */
    following (object: any, options?: OperationOptions) {
        const treeRoot = options && options.root;
     ...
     * @return {Object[]}
     */
    childrenToArray (parent: any, options?: OperationOptions) {
     ...
     * @return {Object[]}
     */
    ancestorsToArray (object: any, options?: OperationOptions) {
        const array = (options && options.array) || [];
        const filter = (options && options.filter) || returnTrue;
        const thisArg = (options && options.thisArg) || undefined;
     ...
     * @return {Object[]}
     */
    treeToArray (root: any, options?: OperationOptions) {
        const array = (options && options.array) || [];
        const filter = (options && options.filter) || returnTrue;
        const thisArg = (options && options.thisArg) || undefined;
     ...
     */
    childrenIterator (parent: any, options?: OperationOptions) {
     ...
     * @return {Object} An iterable iterator (ES6)
     */
    previousSiblingsIterator (object: any) {
        return new TreeIterator(
            this,
            object,
     ...
     * @return {Object} An iterable iterator (ES6)
     */
    nextSiblingsIterator (object: any) {
        return new TreeIterator(
            this,
            object,
     ...
     * @return {Object} An iterable iterator (ES6)
     */
    treeIterator (root: any, options?: OperationOptions) {
        const reverse = options && options.reverse;
     ...
     * @return {Number}
     */
    compareTreePosition (left: any, right: any) {
        // In DOM terms:
     ...
     */
    insertBefore (referenceObject: any, newObject: any) {
     ...
     * @return {Object} newObject
     */
    insertAfter (referenceObject: any, newObject: any) {
        const referenceNode = this._node(referenceObject);
     ...
     * @return {Object} newObject
     */
    prependChild (referenceObject: any, newObject: any) {
        const referenceNode = this._node(referenceObject);
        const newNode = this._node(newObject);
     ...
     * @return {Object} newObject
     */
    appendChild (referenceObject: any, newObject: any) {
        const referenceNode = this._node(referenceObject);
        const newNode = this._node(newObject);
