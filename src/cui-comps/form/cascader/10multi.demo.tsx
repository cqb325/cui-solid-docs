...
import { TreeCheckMod } from "cui-solid"
...
export default () => {
    ...
    const [value, setValue] = createSignal(['gugong'])

    return <Space>
        <Cascader data={data} value={[value, setValue]} showMore showMax={2} multi mode={TreeCheckMod.SHALLOW}/>
    </Space>
}
