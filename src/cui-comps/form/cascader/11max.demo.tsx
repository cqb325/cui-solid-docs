import { Cascader, message, Space, TreeCheckMod } from "cui-solid"
...
export default () => {
    ...
    return <Space>
        <Cascader mode={TreeCheckMod.CHILD} data={data} filter max={2} onExceed={() => message.error('最多只能选择2个')} multi/>
    </Space>
}
